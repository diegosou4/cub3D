...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/11/16 17:36:01 by dde-maga          #+#    #+#             */
/*   Updated: 2024/11/16 17:40:13 by dde-maga         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	draw_aux1(t_game *game)
{
	while (game->draw.y < game->draw.drawendy)
	{
		...
		game->draw.tex_y = ((game->draw.d \
				* game->texture[15].texture.img_height) \
